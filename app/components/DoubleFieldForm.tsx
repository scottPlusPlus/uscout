    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <label className={CSS_CLASSES.LABEL} htmlFor={props.inputFieldName}>
                {props.inputFieldName.charAt(0).toUpperCase() + props.inputFieldName.slice(1)}
            </label>
            <input
            ...
            />
            {props.errors?.inputField && <p className={CSS_CLASSES.ERROR_CLASS}>{props.errors.inputField}</p>}
            ...
            {props.errors?.roleField && <p className={CSS_CLASSES.ERROR_CLASS}>{props.errors.roleField}</p>}
